...
public class GraphicsDisplay extends JPanel {
    ...
    public class MouseHandler extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent ev) {       // Начало выделения области
            if (ev.getButton() == 1) {
        ...
        public void mouseReleased(MouseEvent ev) {    // Завершение выделения области
            if (ev.getButton() == 1) {
    ...
    public class MouseMotionHandler implements MouseMotionListener {
        ...
        public void mouseMoved(MouseEvent ev) {   // Проверка, находится ли мышь над маркером
            GraphicsDisplay.this.selectedMarker = GraphicsDisplay.this.findSelectedPoint(ev.getX(), ev.getY());
            if (GraphicsDisplay.this.selectedMarker >= 0) {
                GraphicsDisplay.this.setCursor(Cursor.getPredefinedCursor(8));
            } else {
        ...
        public void mouseDragged(MouseEvent ev) {       // Режим выделения области
            if (GraphicsDisplay.this.changeMode) {
